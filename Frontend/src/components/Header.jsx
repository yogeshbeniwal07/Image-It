...
const Header = () => {
  ...
  const onClickHandler = () =>{
    ...
    >
      ...
      >
        Unleash your creativity with AI. Turn your imagination into visual art in seconds. Just TYPE, and Watch the MAGIC
      </motion.p>
      ...
      initial={{opacity:0}}
      animate={{opacity:1}}
      transition={{default:{duration:0.5}, opacity:0.8, duration:1}}
      >Generate Images 
      ...
      >
        {Array(5).fill('').map((item, index)=>(
            ...
            className='rounded hover:scale-105 transistion-all duration-300 cursor-pointer max-sm:w-10' src={index%2 == 0 ? assets.ai_gen_3 : assets.ai_gen_4} alt="" key={index} width={70}/>
        ))}
      </motion.div>
      ...
      >Generated images from Image-It</motion.p>
    </motion.div>
  )
}
